...
int task_create (task_t *task, void (*start_func)(void *), void *arg) {
    ...
    (task->timer).it_value.tv_usec = 2;      // primeiro disparo, em micro-segundos
    (task->timer).it_value.tv_sec  = 0;      // primeiro disparo, em segundos
    (task->timer).it_interval.tv_usec = 2;   // disparos subsequentes, em micro-segundos
    (task->timer).it_interval.tv_sec  = 0;   // disparos subsequentes, em segundos
